...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("h-8 w-8 rounded-md", className)} // Slightly larger trigger
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "opacity-0 hover:opacity-100", // Make rail more subtle
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        "h-9 w-full bg-sidebar-accent/10 border-sidebar-border shadow-none focus-visible:ring-2 focus-visible:ring-sidebar-ring placeholder:text-sidebar-foreground/60", // Adjusted styling
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-3 border-b border-sidebar-border", className)} // Added border
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 p-3 border-t border-sidebar-border mt-auto", className)} // Added border and mt-auto
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  return (
    <Separator
      ...
      className={cn("my-2 mx-2 w-auto bg-sidebar-border", className)} // Adjusted margin
      {...props}
    />
  )
})
